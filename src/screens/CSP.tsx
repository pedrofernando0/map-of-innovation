  ...
  const nextSteps = [
    {
      ...
      description: 'A equipe Geekie parte deste diagnóstico para compreender a etapa de ensino, a organização curricular e os desafios mais presentes na rotina da sua escola.'
    },
    {
      title: 'Devolutiva pedagógica',
      description: 'O contato tem como foco aprofundar o significado dos resultados, destacando forças, pontos de atenção e prioridades possíveis para o próximo ciclo.'
    },
    {
      title: 'Aplicação à realidade da escola',
      description: 'A conversa busca traduzir o diagnóstico em encaminhamentos aderentes ao contexto institucional, sem receitas prontas ou propostas desconectadas da prática.'
    }
  ];
        ...
        <div className="rounded-[2rem] border border-[#f2d8de] bg-[linear-gradient(180deg,#fff9f7_0%,#ffffff_100%)] p-8 md:p-12 shadow-[0_28px_80px_-48px_rgba(28,28,28,0.35)]">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Ao solicitar o relatório, a Geekie entrará em contato para compreender o contexto da sua escola, aprofundar a leitura deste diagnóstico e discutir como aplicar os achados à rotina pedagógica específica da instituição.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-[#f3e7ea] bg-white/75 p-6 text-left">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              O retorno considera os dados preenchidos por <strong>{appState.escola.contato_nome || 'sua escola'}</strong> e o e-mail <strong>{appState.escola.contato_email || 'informado no cadastro'}</strong>, para que a conversa parta do diagnóstico já realizado e avance com foco pedagógico.
            </p>
          </div>
